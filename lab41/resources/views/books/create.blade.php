        ...
        <form action="{{ route('books.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="publication_year" value="{{ old('publication_year') }}" class="form-control" required max="{{ date('Y') }}" min="1000">
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="genre" value="{{ old('genre') }}" class="form-control" required>
            </div>
            ...
            <button type="submit" class="btn btn-success">Зачувај книга</button>
        </form>
    </div>
@endsection
